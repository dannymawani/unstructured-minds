...
|-------|-----------|---------|
| activities | `{date}_{type}_{index}` | `20260115_str_1` |
| exercise_log | `{activity_id}_{exercise}_{set_number}` | `20260115_str_1_squat_1` |
...
2. Activity IDs link all exercises in a session: `YYYYMMDD_type_index`
